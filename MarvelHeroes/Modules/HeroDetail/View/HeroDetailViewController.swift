...
class HeroDetailViewController: UIViewController, IdentifiableNib, HeroDetailView {
    ...
    @objc func onRightButtonTapped(_ sender: Any) {
        presenter?.toggleFavoritedHero()
    }
    ...
    private func setupRightButton() {
        ...
        let title = hero.favorite ? "Unfavourite" : "Favorite"
        let rightButton = UIBarButtonItem(title: title, style: .plain, target: self, action: #selector(onRightButtonTapped(_:)))
